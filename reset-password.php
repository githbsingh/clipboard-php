...
<div class="signup-form">
    <form action="reset-password.php" method="post">
		...
		<p class="hint-text">Please fill out this form to reset your password.</p>
		...
		<div class="form-group">
            <button type="submit" class="btn btn-success btn-sm">Submit</button><a class="btn btn-link" style="color:black;"href="index.php">Cancel</a>
        </div>
